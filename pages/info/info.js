...
const Info = () => {
  ...
  const iconButtonStyles = {
    "&:hover": {
      backgroundColor: "lightblue", // Change this to your desired hover background color
    },
  };
      ...
      <Grid>
        ...
        >
          ...
          >
            ...
            <Card
              sx={{
                maxWidth: { lg: "30vw", md: "25vw", sm: "22vw" },
            ...
            {graphResponse.length > 2 && (
              <Box
                sx={{
                  pt: { md:'85px',sm: "145px", xs: "10px" },
                  pl: { sm: "10px", xs: "120px" },
                }}
              >
                <IconButton
                  style={iconButtonStyles}
                  classes={{ root: "MyCustomButton" }}
                  aria-label="delete"
                  size="medium"
            ...
            {graphResponse.length > 2 && (
              ...
              >
                <IconButton
                  ...
                  size="medium"
                  onClick={handleNext}
                  disabled={currentIndex + 2 >= graphResponse.length}
                  sx={{
                    backgroundColor: "white",
                    color: grey[600],
                    borderRadius: "50%",
                      ...
                      return (
                        <>
                          <Card
                            ...
                            sx={{
                              width: { lg: "30vw", md: "25vw", sm: "22vw" },
                              height: { lg: "20vh", md: "26vh", sm: "40vh" },
